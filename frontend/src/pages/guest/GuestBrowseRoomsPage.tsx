...
export function GuestBrowseRoomsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {rooms && rooms.length === 0 && <p className="text-sm text-ink-400 text-center">No rooms available for these dates.</p>}

      {rooms?.map((room) => (
        <div key={room.room_id} className="rounded-lg border border-ink-200 bg-white p-4 flex items-center justify-between">
          <div>
