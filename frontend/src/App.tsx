          ...
          <Routes>
            ...
            <Route element={<GuestProtectedRoute />}>
              <Route element={<GuestLayout />}>
                ...
                <Route path="/guest/bookings/:reservationId" element={<GuestBookingDetailPage />} />
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<AppLayout />}>
                ...
                <Route element={<ProtectedRoute allowedRoles={["FRONT_DESK", "MANAGER"]} />}>
                ...
                <Route
                  element={<ProtectedRoute allowedRoles={["HOUSEKEEPING", "FRONT_DESK", "MANAGER"]} />}
                >
